...
export default function RootLayout({
  ...
  return (
    <ClerkProvider appearance={{ baseTheme: dark }}>
      <html lang="en">
        <body className={`${inter.className} bg-zinc-950 text-slate-50 antialiased flex min-h-screen relative`}>
          <DynamicIsland />
          
          {/* Sidebar for desktop */}
          <div className="hidden md:block w-64 border-r border-zinc-800 bg-zinc-950">
            <Sidebar />
          </div>
